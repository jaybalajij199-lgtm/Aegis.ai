...
// Replace DISTRICT_PRESETS render with search bar
content = content.replace(
  /\{\/\* District Preset Navigation \*\/\}(.|\n)*?<\/div>/m,
  `{/* Location Search Navigation */}
      <div className="flex flex-col md:flex-row items-center gap-3">
        ...
        <Button onClick={handleSearch} className="bg-cyan-600 hover:bg-cyan-500 text-slate-950 font-black">
          Search Location
        </Button>
      </div>
